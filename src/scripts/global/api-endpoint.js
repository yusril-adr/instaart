...
const API_ENDPOINT = {
  ...
  RECOVERY_TOKEN: `${CONFIG.API_BASE_URL}/recovery-token.php`,
  RECOVERY_PASSWORD: `${CONFIG.API_BASE_URL}/recovery-password.php`,
  SEND_TOKEN: 'https://instaart-mailer.herokuapp.com',
