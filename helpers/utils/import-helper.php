<?php 
  require_once "../helpers/data/mysql.php";
  require_once "../helpers/models/token.php";
  require_once "../helpers/models/user.php";
  require_once "../helpers/models/categories.php";
  ...
  require_once "../helpers/utils/url-helper.php";
?>